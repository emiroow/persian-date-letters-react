...
const index = () => {
  ...
  function ConvertNumToPersianMonth(num: any) {
    let monthName = "";
  ...
  function ConvertDateToLetters(date: string) {
    let dateInLetters = "";
    const M = "م";
    const Three = "سوم";
    ...
    if (date == null || date == "" || date == undefined) {
      ...
      if (dateInNum != null && dateInNum != "" && dateInNum != undefined) {
        if (dateInNum.length == 8) {
          ...
          const strMonth = ConvertNumToPersianMonth(dateInNum.substr(4, 2));
          let strDay = "";
  ...
  return { value, setValue, ConvertDateToLetters };
};
